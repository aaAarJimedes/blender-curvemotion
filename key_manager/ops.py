...
class CURVEMOTION_OT_key_manager_settings(Operator):
...
class AAT_OT_clone(Operator):
    ...
    bl_idname = 'curvemotion.fcurve_clone'
    ...
    def execute(self, context):
        curvemotion = context.scene.curvemotion
        cycle_before = curvemotion.clone.cycle_before
        cycle_after = curvemotion.clone.cycle_after
...
class AAT_OT_clone_remove(Operator):
    ...
    bl_idname = 'curvemotion.remove_clone'
