...
def handles_type_row(context, layout, act_on, name, icon='NONE', handle_type='NONE'):
    ...
    if not utils.general.poll(context):
        subcol.active = False
    key_tweak = context.scene.curvemotion.key_tweak
...
class CURVEMOTION_PT_key_manager:
...
class CURVEMOTION_PT_key_manager_ge(Panel, CURVEMOTION_PT_key_manager):
    bl_region_type = 'UI'
    bl_category = 'CurveMotion'
    bl_idname = 'CURVEMOTION_PT_key_manager_ge'
    bl_space_type = 'GRAPH_EDITOR'


class CURVEMOTION_PT_key_manager_de(Panel, CURVEMOTION_PT_key_manager):
    bl_region_type = 'UI'
    bl_category = 'CurveMotion'
    bl_idname = 'CURVEMOTION_PT_key_manager_de'
    bl_space_type = 'DOPESHEET_EDITOR'


class CURVEMOTION_PT_key_manager_header(Panel, CURVEMOTION_PT_key_manager):
    bl_options = {'HIDE_HEADER'}
    bl_region_type = 'HEADER'
    bl_idname = 'CURVEMOTION_PT_key_manager_header'
    bl_space_type = 'GRAPH_EDITOR'
...
class CURVEMOTION_PT_move_keys:
...
class CURVEMOTION_PT_move_keys_ge(Panel, CURVEMOTION_PT_move_keys):
    bl_region_type = 'UI'
    bl_category = 'CurveMotion'
    bl_idname = 'CURVEMOTION_PT_move_keys_ge'
    bl_space_type = 'GRAPH_EDITOR'
    bl_parent_id = 'CURVEMOTION_PT_key_manager_ge'


class CURVEMOTION_PT_move_keys_de(Panel, CURVEMOTION_PT_move_keys):
    bl_region_type = 'UI'
    bl_category = 'CurveMotion'
    bl_idname = 'CURVEMOTION_PT_move_keys_de'
    bl_space_type = 'DOPESHEET_EDITOR'
    bl_parent_id = 'CURVEMOTION_PT_key_manager_de'


class CURVEMOTION_PT_move_keys_header(Panel, CURVEMOTION_PT_move_keys):
    bl_region_type = 'HEADER'
    bl_idname = 'CURVEMOTION_PT_move_keys_header'
    bl_space_type = 'GRAPH_EDITOR'
    bl_parent_id = 'CURVEMOTION_PT_key_manager_header'


class CURVEMOTION_PT_key_type:
    bl_label = "Type"
    # bl_region_type = 'UI'
    # bl_category = 'CurveMotion'
    # bl_space_type = 'DOPESHEET_EDITOR'
...
class CURVEMOTION_PT_key_type_ge(Panel, CURVEMOTION_PT_key_type):
    bl_region_type = 'UI'
    bl_category = 'CurveMotion'
    bl_idname = 'CURVEMOTION_PT_key_type_ge'
    bl_space_type = 'GRAPH_EDITOR'
    bl_parent_id = 'CURVEMOTION_PT_key_manager_ge'


class CURVEMOTION_PT_key_type_de(Panel, CURVEMOTION_PT_key_type):
    bl_region_type = 'UI'
    bl_category = 'CurveMotion'
    bl_idname = 'CURVEMOTION_PT_key_type_de'
    bl_space_type = 'DOPESHEET_EDITOR'
    bl_parent_id = 'CURVEMOTION_PT_key_manager_de'


class CURVEMOTION_PT_key_type_header(Panel, CURVEMOTION_PT_key_type):
    bl_region_type = 'HEADER'
    bl_idname = 'CURVEMOTION_PT_key_type_header'
    bl_space_type = 'GRAPH_EDITOR'
    bl_parent_id = 'CURVEMOTION_PT_key_manager_header'


class CURVEMOTION_PT_key_interp:
...
class CURVEMOTION_PT_key_interp_ge(Panel, CURVEMOTION_PT_key_interp):
    bl_region_type = 'UI'
    bl_category = 'CurveMotion'
    bl_idname = 'CURVEMOTION_PT_key_interp_ge'
    bl_space_type = 'GRAPH_EDITOR'
    bl_parent_id = 'CURVEMOTION_PT_key_manager_ge'


class CURVEMOTION_PT_key_interp_header(Panel, CURVEMOTION_PT_key_interp):
    bl_region_type = 'HEADER'
    bl_idname = 'CURVEMOTION_PT_key_interp_header'
    bl_space_type = 'GRAPH_EDITOR'
    # bl_parent_id = 'CURVEMOTION_PT_key_manager_header'
...
def draw_key_interpolation(self, context):
    ...
    row.popover(panel="CURVEMOTION_PT_key_interp_header", text="", icon='FORCE_HARMONIC')
    # row.separator()
...
def draw_key_manager(self, context):
    layout = self.layout
    row = layout.row(align=False)
    row.popover(panel="CURVEMOTION_PT_key_manager_header", text="", icon='CON_ACTION')
    if context.area.type == 'GRAPH_EDITOR':
        row.popover(panel="CURVEMOTION_PT_key_interp_header", text="", icon='FORCE_HARMONIC')
    # row.separator()
...
panel_classes = (
    CURVEMOTION_PT_key_manager_ge,
    CURVEMOTION_PT_key_manager_de,
    CURVEMOTION_PT_move_keys_ge,
    CURVEMOTION_PT_move_keys_de,
    CURVEMOTION_PT_key_type_ge,
    CURVEMOTION_PT_key_type_de,
    CURVEMOTION_PT_key_interp_ge,
)


header_classes = (
    CURVEMOTION_PT_key_manager_header,
    CURVEMOTION_PT_move_keys_header,
    CURVEMOTION_PT_key_type_header,
    CURVEMOTION_PT_key_interp_header,
)
