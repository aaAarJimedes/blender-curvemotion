...
class CURVEMOTION_PT_curve_tools:
...
class CURVEMOTION_PT_curve_tools_ge(Panel, CURVEMOTION_PT_curve_tools):
    bl_idname = 'CURVEMOTION_PT_curve_tools_ge'
    bl_space_type = 'GRAPH_EDITOR'


class CURVEMOTION_PT_curve_tools_de(Panel, CURVEMOTION_PT_curve_tools):
    bl_idname = 'CURVEMOTION_PT_curve_tools_de'
    bl_space_type = 'DOPESHEET_EDITOR'


class CURVEMOTION_PT_curve_tools_3d(Panel, CURVEMOTION_PT_curve_tools):
    bl_label = "On Frame Curve Tools"
    bl_idname = 'CURVEMOTION_PT_curve_tools_3d'
    bl_space_type = 'VIEW_3D'


class CURVEMOTION_UL_frame_bookmarks(UIList):
...
class CURVEMOTION_PT_frame_bookmarks:
    ...
    def draw(self, context):
        ...
        row.template_list("CURVEMOTION_UL_frame_bookmarks", "", tool, "frame_bookmarks", tool, "bookmark_index")
...
class CURVEMOTION_PT_frame_bookmarks_ge(Panel, CURVEMOTION_PT_frame_bookmarks):
    bl_idname = 'CURVEMOTION_PT_frame_bookmarks_ge'
    bl_space_type = 'GRAPH_EDITOR'
    bl_parent_id = 'CURVEMOTION_PT_curve_tools_ge'


class CURVEMOTION_PT_frame_bookmarks_3d(Panel, CURVEMOTION_PT_frame_bookmarks):
    bl_idname = 'CURVEMOTION_PT_frame_bookmarks_3d'
    bl_space_type = 'VIEW_3D'
    bl_parent_id = 'CURVEMOTION_PT_curve_tools_3d'


class CURVEMOTION_PT_frame_bookmarks_de(Panel, CURVEMOTION_PT_frame_bookmarks):
    bl_idname = 'CURVEMOTION_PT_frame_bookmarks_de'
    bl_space_type = 'DOPESHEET_EDITOR'
    bl_parent_id = 'CURVEMOTION_PT_curve_tools_de'


class CURVEMOTION_MT_curve_tools(Menu):
    bl_idname = 'CURVEMOTION_MT_curve_tools'
    bl_label = "Curve Tools"
...
class CURVEMOTION_MT_tweak(Menu):
    bl_idname = 'CURVEMOTION_MT_tweak'
    bl_label = "Tweak"
...
class CURVEMOTION_MT_curve_tools_pie(Menu):
    bl_idname = 'CURVEMOTION_MT_curve_tools_pie'
    ...
    def draw(self, context):
        ...
        layout.operator('wm.call_menu_pie', text="Group A").name = 'CURVEMOTION_MT_pie_curve_tools_a'
        layout.operator('wm.call_menu_pie', text="Group B").name = 'CURVEMOTION_MT_pie_curve_tools_b'


class CURVEMOTION_MT_pie_curve_tools_a(Menu):
    bl_idname = "CURVEMOTION_MT_pie_curve_tools_a"
...
class CURVEMOTION_MT_pie_curve_tools_b(Menu):
    bl_idname = "CURVEMOTION_MT_pie_curve_tools_b"
...
class CURVEMOTION_MT_pie_curve_tools_3d(Menu):
    bl_idname = "CURVEMOTION_MT_pie_curve_tools_3d"
    bl_label = "Curve Tools"
...
def draw_bookmarks(self, context):
    layout = self.layout
    row = layout.row(align=False)
    row.popover(panel="CURVEMOTION_PT_frame_bookmarks_ge", text="", icon='BOOKMARKS')
    row.separator()


classes = (
    CURVEMOTION_PT_curve_tools_ge,
    CURVEMOTION_PT_curve_tools_de,
    CURVEMOTION_PT_curve_tools_3d,
    CURVEMOTION_UL_frame_bookmarks,
    CURVEMOTION_PT_frame_bookmarks_ge,
    CURVEMOTION_PT_frame_bookmarks_de,
    CURVEMOTION_PT_frame_bookmarks_3d,
    CURVEMOTION_MT_pie_curve_tools_a,
    CURVEMOTION_MT_pie_curve_tools_b,
    CURVEMOTION_MT_pie_curve_tools_3d,
    CURVEMOTION_MT_curve_tools,
    CURVEMOTION_MT_tweak,
    CURVEMOTION_MT_curve_tools_pie
)
