...
class CurveMotionClone(PropertyGroup):
...
class CurveMotionFrameBookmark(PropertyGroup):
    frame: IntProperty()
    name: StringProperty()


class CurveMotionTool(PropertyGroup):
    ...
    frame_bookmarks: CollectionProperty(type=CurveMotionFrameBookmark)
