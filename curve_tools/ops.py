...
class CURVEMOTION_OT:
    ...
    def reset_tool_factor(self, context):
        tool = context.scene.curvemotion.tool
    ...
    def start(self, context, event):
        self.activated = True
        # context.scene.curvemotion.tool.show_factor = True
        self.init_mouse_x = event.mouse_x

    def end(self, context):
        self.activated = False
        # context.scene.curvemotion.tool.show_factor = False
    ...
    def invoke(self, context, event):
        ...
        #     curvemotion.tool.keys_under_cursor = False
        # else:
        #     curvemotion.tool.keys_under_cursor = True

        context.window_manager.modal_handler_add(self)
        return {'RUNNING_MODAL'}


class CURVEMOTION_OT_ease_to_ease(Operator, CURVEMOTION_OT):
...
class CURVEMOTION_OT_ease(Operator, CURVEMOTION_OT):
    """Transition selected or current keys from the neighboring\n""" \
...
class CURVEMOTION_OT_blend_ease(Operator, CURVEMOTION_OT):
...
class CURVEMOTION_OT_blend_neighbor(Operator, CURVEMOTION_OT):
...
class CURVEMOTION_OT_blend_default(Operator, CURVEMOTION_OT):
...
class CURVEMOTION_OT_blend_infinite(Operator, CURVEMOTION_OT):
...
class CURVEMOTION_OT_blend_frame(Operator, CURVEMOTION_OT):
...
class CURVEMOTION_OT_blend_offset(Operator, CURVEMOTION_OT):
...
class CURVEMOTION_OT_tween(Operator, CURVEMOTION_OT):
...
class CURVEMOTION_OT_push_pull(Operator, CURVEMOTION_OT):
...
class CURVEMOTION_OT_smooth(Operator, CURVEMOTION_OT):
...
class CURVEMOTION_OT_time_offset(Operator, CURVEMOTION_OT):
    ...
    def tool(self, context):
        ...
        if self.selected_keys:
            ...
            cycle = self.curvemotion.clone.cycle
...
class CURVEMOTION_OT_shear_right(Operator, CURVEMOTION_OT):
    """Shift the value in time of selected or current keys """
    ...
    def tool(self, context):
        ...
        if self.selected_keys:
            ...
            # shear_action = utils.set_curvemotion_action()
...
class CURVEMOTION_OT_shear_left(Operator, CURVEMOTION_OT):
    """Shift the value in time of selected or current keys """
...
class CURVEMOTION_OT_wave_noise(Operator, CURVEMOTION_OT):
    ...
    def tool(self, context):
        ...
        if self.selected_keys:
            ...
            if factor > 0:
                ...
                phase = self.curvemotion.tool.noise_phase + self.noise_steps
                scale = self.curvemotion.tool.noise_scale
...
class CURVEMOTION_OT_scale_left(Operator, CURVEMOTION_OT):
...
class CURVEMOTION_OT_scale_right(Operator, CURVEMOTION_OT):
    """Increase or decrease the value of selected or current keys \n""" \
...
class CURVEMOTION_OT_scale_average(Operator, CURVEMOTION_OT):
    """Increase or decrease the value of selected or current keys \n""" \
...
class CURVEMOTION_OT_tools_settings(Operator):
...
class CURVEMOTION_OT_add_bookmark(Operator):
...
class CURVEMOTION_OT_delete_bookmark(Operator):
...
class CURVEMOTION_OT_push_bookmark(Operator):
...
class CURVEMOTION_OT_get_ref_frame(Operator):
...
class CURVEMOTION_OT_modifier(Operator):
    ...
    def execute(self, context):
        ...
        for obj in objects:
            ...
            for curve in utils.action_fcurves(action):
...
class CURVEMOTION_OT_path(Operator):
...
classes = (
    CURVEMOTION_OT_tools_settings,
    CURVEMOTION_OT_get_ref_frame,
    CURVEMOTION_OT_push_bookmark,
    CURVEMOTION_OT_add_bookmark,
    CURVEMOTION_OT_delete_bookmark,
    CURVEMOTION_OT_ease_to_ease,
    CURVEMOTION_OT_ease,
    CURVEMOTION_OT_blend_ease,
    CURVEMOTION_OT_blend_neighbor,
    CURVEMOTION_OT_blend_frame,
    CURVEMOTION_OT_blend_default,
    CURVEMOTION_OT_blend_offset,
    CURVEMOTION_OT_push_pull,
    CURVEMOTION_OT_scale_average,
    CURVEMOTION_OT_scale_left,
    CURVEMOTION_OT_scale_right,
    CURVEMOTION_OT_smooth,
    CURVEMOTION_OT_wave_noise,
    CURVEMOTION_OT_time_offset,
    CURVEMOTION_OT_shear_left,
    CURVEMOTION_OT_shear_right,
    CURVEMOTION_OT_tween,
    CURVEMOTION_OT_blend_infinite,
)
