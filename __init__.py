...
bl_info = {
    ...
    "author": "Ares Deveaux (original AnimAide), CurveMotion contributors",
    "version": (1, 0, 39),
    "blender": (5, 1, 0),
    "location": "Graph Editor - Dope Sheet - Timeline - 3D View - sidebar and menu bar",
    "warning": "Community build for Blender 5.1.",
    "category": "Animation",
    "doc_url": "https://github.com/aaAarJimedes/blender-curvemotion",
    "tracker_url": "https://github.com/aaAarJimedes/blender-curvemotion/issues"
}
...
class CurveMotionScene(PropertyGroup):
    clone: PointerProperty(type=curve_tools.props.CurveMotionClone)
    tool: PointerProperty(type=curve_tools.props.CurveMotionTool)
    anim_offset: PointerProperty(type=anim_offset.props.CurveMotionOffset)
...
def register():
    ...
    bpy.types.Scene.curvemotion = PointerProperty(type=CurveMotionScene)
...
def unregister():
    ...
    del bpy.types.Scene.curvemotion
