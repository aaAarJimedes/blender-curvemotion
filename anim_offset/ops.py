...
class CURVEMOTION_OT_modal_test(Operator):
...
class CURVEMOTION_OT_activate_anim_offset(Operator):
...
class CURVEMOTION_OT_deactivate_anim_offset(Operator):
...
class CURVEMOTION_OT_add_anim_offset_mask(Operator):
    ...
    def finish_mask(self, context):
        ...
        context.scene.curvemotion.anim_offset.mask_in_use = True
        context.area.tag_redraw()
...
class CURVEMOTION_OT_delete_anim_offset_mask(Operator):
...
class CURVEMOTION_OT_anim_offset_settings(Operator):
...
classes = (
    # CURVEMOTION_OT_modal_test,
    CURVEMOTION_OT_add_anim_offset_mask,
    CURVEMOTION_OT_activate_anim_offset,
    CURVEMOTION_OT_deactivate_anim_offset,
    CURVEMOTION_OT_delete_anim_offset_mask,
    CURVEMOTION_OT_anim_offset_settings,
)
